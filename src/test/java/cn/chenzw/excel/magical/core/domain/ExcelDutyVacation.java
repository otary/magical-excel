...
public class ExcelDutyVacation {
    ...
    @ExcelExportColumn(colIndex = 1, title = "人员用户名")
     ...
     * 休假类型
     **/
    @ExcelExportColumn(colIndex = 2, title = "休假类型")
     ...
     * 休假开始时间
     **/
    @ExcelExportColumn(colIndex = 3, title = "休假起始时间", dataFormat = @ExcelDataFormat("yyyy/MM/dd"))
     ...
     * 休假结束时间
     **/
    @ExcelExportColumn(colIndex = 4, title = "休假结束时间", dataFormat = @ExcelDataFormat("yyyy/MM/dd"))
    @ExcelImportColumn(colIndex = 4, allowBlank = false, dateFormat = "yyyy/MM/dd")
    private Date endDate;

    @ExcelExportColumn(colIndex = 5, title = "备注")
